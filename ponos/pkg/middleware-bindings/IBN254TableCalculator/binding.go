...
func (_IBN254TableCalculator *IBN254TableCalculatorCaller) CalculateOperatorTable(opts *bind.CallOpts, operatorSet OperatorSet) (IOperatorTableCalculatorTypesBN254OperatorSetInfo, error) {
	var out []interface{}
...
//
// Solidity: function calculateOperatorTable((address,uint32) operatorSet) view returns((bytes32,uint256,(uint256,uint256),uint256[]) operatorSetInfo)
func (_IBN254TableCalculator *IBN254TableCalculatorSession) CalculateOperatorTable(operatorSet OperatorSet) (IOperatorTableCalculatorTypesBN254OperatorSetInfo, error) {
...
//
// Solidity: function calculateOperatorTable((address,uint32) operatorSet) view returns((bytes32,uint256,(uint256,uint256),uint256[]) operatorSetInfo)
func (_IBN254TableCalculator *IBN254TableCalculatorCallerSession) CalculateOperatorTable(operatorSet OperatorSet) (IOperatorTableCalculatorTypesBN254OperatorSetInfo, error) {
	return _IBN254TableCalculator.Contract.CalculateOperatorTable(&_IBN254TableCalculator.CallOpts, operatorSet)
}
...
func (_IBN254TableCalculator *IBN254TableCalculatorCaller) GetOperatorInfos(opts *bind.CallOpts, operatorSet OperatorSet) ([]IOperatorTableCalculatorTypesBN254OperatorInfo, error) {
	var out []interface{}
...
//
// Solidity: function getOperatorInfos((address,uint32) operatorSet) view returns(((uint256,uint256),uint256[])[] operatorInfos)
func (_IBN254TableCalculator *IBN254TableCalculatorSession) GetOperatorInfos(operatorSet OperatorSet) ([]IOperatorTableCalculatorTypesBN254OperatorInfo, error) {
...
//
// Solidity: function getOperatorInfos((address,uint32) operatorSet) view returns(((uint256,uint256),uint256[])[] operatorInfos)
func (_IBN254TableCalculator *IBN254TableCalculatorCallerSession) GetOperatorInfos(operatorSet OperatorSet) ([]IOperatorTableCalculatorTypesBN254OperatorInfo, error) {
	return _IBN254TableCalculator.Contract.GetOperatorInfos(&_IBN254TableCalculator.CallOpts, operatorSet)
}
