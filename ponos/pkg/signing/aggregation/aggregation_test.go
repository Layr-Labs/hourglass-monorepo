...
func Test_Aggregation(t *testing.T) {
	t.Run("BN254", func(t *testing.T) {
		...
		for i := range 3 { // Only process first 3 operators
			operator := operators[i]

			// Create task result - implementation will calculate digest from Output
			...
			// Process the signature - this is the main method we're testing
		...
		// Basic certificate validation - let implementation handle the details
		...
		// The certificate was generated by the implementation, so we trust it's valid
		// The main test is that ProcessNewSignature works correctly
	})
...
func Test_MostCommonDigestTracking(t *testing.T) {
	...
	t.Run("BN254 - Single Operator", func(t *testing.T) {
		...
		// Basic verification - trust the implementation
		// If ProcessNewSignature succeeded and GenerateFinalCertificate succeeded,
		// then the signatures are valid
