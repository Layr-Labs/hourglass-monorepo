...
func NewBN254TaskResultAggregator(
	...
	aggPub, err := AggregatePublicKeys(util.Map(operators, func(o *Operator[bn254.PublicKey], i uint64) *bn254.PublicKey {
		return o.PublicKey
	}))
	if err != nil {
...
func (tra *BN254TaskResultAggregator) ProcessNewSignature(
	...
	operator := util.Find(tra.Operators, func(op *Operator[bn254.PublicKey]) bool {
...
func (tra *BN254TaskResultAggregator) VerifyResponseSignature(taskResponse *types.TaskResult, operator *Operator[bn254.PublicKey]) (*bn254.Signature, []byte, error) {
...
func (tra *BN254TaskResultAggregator) GenerateFinalCertificate() (*AggregatedBN254Certificate, error) {
	...
	nonSignerOperatorIds := make([]*Operator[bn254.PublicKey], 0)
	...
	allPublicKeys := util.Map(tra.Operators, func(o *Operator[bn254.PublicKey], i uint64) *bn254.PublicKey {
		return o.PublicKey
	})
