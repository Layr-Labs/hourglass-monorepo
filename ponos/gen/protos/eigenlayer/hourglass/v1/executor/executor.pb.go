...
const file_eigenlayer_hourglass_v1_executor_executor_proto_rawDesc = "" +
	"\n" +
	"/eigenlayer/hourglass/v1/executor/executor.proto\x12\x17eigenlayer.hourglass.v1\x1a eigenlayer/common/v1/types.proto\"\xaf\x01\n" +
	"\x0eTaskSubmission\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12-\n" +
	"\x12aggregator_address\x18\x02 \x01(\tR\x11aggregatorAddress\x12\x18\n" +
	"\apayload\x18\x04 \x01(\fR\apayload\x12\x1d\n" +
	"\n" +
	"public_key\x18\x05 \x01(\tR\tpublicKey\x12\x1c\n" +
	"\tsignature\x18\x06 \x01(\fR\tsignature2k\n" +
