...
type DeployArtifactRequest struct {
	...
	Auth          *AuthSignature         `protobuf:"bytes,5,opt,name=auth,proto3" json:"auth,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_eigenlayer_hourglass_v1_executor_executor_proto_rawDesc = "" +
	...
	"avsAddress\x12&\n" +
	"\x0foperator_set_id\x18\x06 \x01(\rR\roperatorSetId\x12#\n" +
	"\routput_digest\x18\a \x01(\fR\foutputDigest\"\xe8\x01\n" +
	...
	"\x03env\x18\x04 \x03(\v2%.eigenlayer.hourglass.v1.PerformerEnvR\x03env\x12:\n" +
	"\x04auth\x18\x05 \x01(\v2&.eigenlayer.hourglass.v1.AuthSignatureR\x04auth\"q\n" +
	...
	"\vavs_address\x18\x01 \x01(\tR\n" +
	"avsAddress\x12:\n" +
	"\x04auth\x18\x02 \x01(\v2&.eigenlayer.hourglass.v1.AuthSignatureR\x04auth\"^\n" +
	"\fPerformerEnv\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x12$\n" +
	"\x0evalue_from_env\x18\x03 \x01(\tR\fvalueFromEnv\"\x8b\x03\n" +
	"\tPerformer\x12!\n" +
...
var file_eigenlayer_hourglass_v1_executor_executor_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_eigenlayer_hourglass_v1_executor_executor_proto_goTypes = []any{
	...
	(*Performer)(nil),                 // 7: eigenlayer.hourglass.v1.Performer
	(*ListPerformersResponse)(nil),    // 8: eigenlayer.hourglass.v1.ListPerformersResponse
	(*RemovePerformerRequest)(nil),    // 9: eigenlayer.hourglass.v1.RemovePerformerRequest
	(*RemovePerformerResponse)(nil),   // 10: eigenlayer.hourglass.v1.RemovePerformerResponse
	(*GetChallengeTokenRequest)(nil),  // 11: eigenlayer.hourglass.v1.GetChallengeTokenRequest
	(*GetChallengeTokenResponse)(nil), // 12: eigenlayer.hourglass.v1.GetChallengeTokenResponse
}
var file_eigenlayer_hourglass_v1_executor_executor_proto_depIdxs = []int32{
	...
	0,  // 1: eigenlayer.hourglass.v1.DeployArtifactRequest.auth:type_name -> eigenlayer.hourglass.v1.AuthSignature
	0,  // 2: eigenlayer.hourglass.v1.ListPerformersRequest.auth:type_name -> eigenlayer.hourglass.v1.AuthSignature
	7,  // 3: eigenlayer.hourglass.v1.ListPerformersResponse.performers:type_name -> eigenlayer.hourglass.v1.Performer
	0,  // 4: eigenlayer.hourglass.v1.RemovePerformerRequest.auth:type_name -> eigenlayer.hourglass.v1.AuthSignature
	1,  // 5: eigenlayer.hourglass.v1.ExecutorService.SubmitTask:input_type -> eigenlayer.hourglass.v1.TaskSubmission
	3,  // 6: eigenlayer.hourglass.v1.ExecutorManagementService.DeployArtifact:input_type -> eigenlayer.hourglass.v1.DeployArtifactRequest
	5,  // 7: eigenlayer.hourglass.v1.ExecutorManagementService.ListPerformers:input_type -> eigenlayer.hourglass.v1.ListPerformersRequest
	9,  // 8: eigenlayer.hourglass.v1.ExecutorManagementService.RemovePerformer:input_type -> eigenlayer.hourglass.v1.RemovePerformerRequest
	11, // 9: eigenlayer.hourglass.v1.ExecutorManagementService.GetChallengeToken:input_type -> eigenlayer.hourglass.v1.GetChallengeTokenRequest
	2,  // 10: eigenlayer.hourglass.v1.ExecutorService.SubmitTask:output_type -> eigenlayer.hourglass.v1.TaskResult
	4,  // 11: eigenlayer.hourglass.v1.ExecutorManagementService.DeployArtifact:output_type -> eigenlayer.hourglass.v1.DeployArtifactResponse
	8,  // 12: eigenlayer.hourglass.v1.ExecutorManagementService.ListPerformers:output_type -> eigenlayer.hourglass.v1.ListPerformersResponse
	10, // 13: eigenlayer.hourglass.v1.ExecutorManagementService.RemovePerformer:output_type -> eigenlayer.hourglass.v1.RemovePerformerResponse
	12, // 14: eigenlayer.hourglass.v1.ExecutorManagementService.GetChallengeToken:output_type -> eigenlayer.hourglass.v1.GetChallengeTokenResponse
