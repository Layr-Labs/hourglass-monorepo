...
import {IAllocationManager} from "@eigenlayer-middleware/lib/eigenlayer-contracts/src/contracts/interfaces/IAllocationManager.sol";
import {IAVSRegistrar} from "@eigenlayer-middleware/lib/eigenlayer-contracts/src/contracts/interfaces/IAVSRegistrar.sol";
import {IPermissionController} from "@eigenlayer-middleware/lib/eigenlayer-contracts/src/contracts/interfaces/IPermissionController.sol";
...
contract DeployAndRegisterAVS is Script {
    ...
    IPermissionController public PERMISSION_CONTROLLER = IPermissionController(0x25E5F8B1E7aDf44518d35D5B2271f114e081f0E5);

    function setUp() public {}

    function run(string memory metadataURI) public {
