...
import {IKeyRegistrar,IKeyRegistrarTypes} from "../../lib/eigenlayer-middleware/lib/eigenlayer-contracts/src/contracts/interfaces/IKeyRegistrar.sol";
...
contract SomeFunc is Script {
    function run() external {
        ...
        IKeyRegistrar KEY_REGISTRAR = IKeyRegistrar(0x1C84Bb62fE7791e173014A879C706445fa893BbE);
        ...
        KEY_REGISTRAR.configureOperatorSet(
            OperatorSet({
                avs: avsAddr,
                id: 0
            }),
