...
//	"github.com/Layr-Labs/hourglass-monorepo/hgctl-go/internal/testutils"
...
//
//	cfg := client.DefaultWeb3SignerConfig()
//	c, err := client.NewWeb3Signer(cfg, l)
...
//		s, err := NewWeb3Signer(c, fromAddress, publicKey, config.CurveTypeECDSA, l)
//		require.NoError(t, err)
//		assert.NotNil(t, s)
//
//		web3Signer, ok := s.(*Web3Signer)
//		require.True(t, ok)
//		assert.Equal(t, c, web3Signer.client)
...
//		publicKey := "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef12"
//		s, err := NewWeb3Signer(c, fromAddress, publicKey, config.CurveTypeBN254, l)
//		assert.Error(t, err)
//		assert.Nil(t, s)
...
//		publicKey := "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef12"
//		s, err := NewWeb3Signer(nil, fromAddress, publicKey, config.CurveTypeECDSA, l)
//		assert.Error(t, err)
//		assert.Nil(t, s)
...
//		publicKey := "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef12"
//		s, err := NewWeb3Signer(c, fromAddress, publicKey, config.CurveTypeECDSA, nil)
//		assert.Error(t, err)
//		assert.Nil(t, s)
...
//		s, err := NewWeb3Signer(c, fromAddress, "", config.CurveTypeECDSA, l)
//		assert.Error(t, err)
//		assert.Nil(t, s)
...
//		require.NoError(t, err)
//
//		s, err := NewWeb3Signer(c, fromAddress, "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef12", config.CurveTypeECDSA, l)
//		require.NoError(t, err)
//
//		signature, err := s.SignMessage(testData)
//		require.NoError(t, err)
//
...
//
//		var web3SignerErr *client.Web3SignerError
...
//		require.NoError(t, err)
//
//		signature, err := s.SignMessageForSolidity(testData)
//		require.NoError(t, err)
//
//		expectedBytes, err := hex.DecodeString(expectedSignature[2:]) // Remove 0x prefix
//		require.NoError(t, err)
...
//
//			response := client.JSONRPCResponse{
//				Jsonrpc: "2.0",
//				Result:  accounts,
//				ID:      req.ID,
//			}
...
//	fromAddress := common.HexToAddress("0x1234567890abcdef1234567890abcdef12345678")
//
//	signerImpl, err := NewWeb3Signer(c, fromAddress, "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef12", config.CurveTypeECDSA, l)
//	require.NoError(t, err)
//
...
//	cm := harness.NewChainManager(l)
//	chainConfig, err := cm.LoadChainConfig()
//	require.NoError(t, err)
//
//	// Configure web3signer client to connect to test server
//	cfg := client.DefaultWeb3SignerConfig()
//	cfg.BaseURL = testutils.L1Web3SignerUrl
//	c, err := client.NewWeb3Signer(cfg, l)
//	require.NoError(t, err)
//
...
//		signature, err := s.SignMessageForSolidity([]byte("Solidity test data"))
//
//		if err != nil {
...
//	require.NoError(t, err)
//
//	privateKey, err := ecdsa.NewPrivateKeyFromHexString(chainConfig.OperatorAccountPk)
//	require.NoError(t, err)
//
//	ims := inMemorySigner.NewInMemorySigner(privateKey, signer.CurveTypeECDSA)
//
//	cfg := client.DefaultWeb3SignerConfig()
//	cfg.BaseURL = testutils.L1Web3SignerUrl
//	s, err := client.NewWeb3Signer(cfg, l)
//	require.NoError(t, err)
//
//	web3Signer, err := NewWeb3Signer(s, common.HexToAddress(chainConfig.OperatorAccountAddress), chainConfig.OperatorAccountPublicKey, config.CurveTypeECDSA, l)
//	require.NoError(t, err)
//
