...
func testEthAccountsIntegration(t *testing.T, client *Web3SignerClient) {
	ctx := context.Background()
...
func testEthSignIntegration(t *testing.T, client *Web3SignerClient, account string) {
	ctx := context.Background()
...
func testEthSignTransactionIntegration(t *testing.T, client *Web3SignerClient, account string) {
	ctx := context.Background()
...
func createTestClient(t *testing.T) *Web3SignerClient {
	...
	c, err := NewWeb3SignerClient(config, l)
	require.NoError(t, err)
	return c
}

// waitForService waits for the Web3SignerClient service to be ready
func waitForService(c *Web3SignerClient, timeout time.Duration) error {
