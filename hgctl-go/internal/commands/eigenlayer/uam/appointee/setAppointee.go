...
Usage:
  hgctl eigenlayer user appointee set --appointee-address 0x5678... --target 0xABCD... --selector 0x12345678
  hgctl eigenlayer user appointee set --account-address 0x1234... --appointee-address 0x5678... --target 0xABCD... --selector 0x12345678`,
		Flags: []cli.Flag{
			&cli.StringFlag{
...
func setAppointeeAction(c *cli.Context) error {
	...
	err = contractClient.SetAppointee(c.Context, accountAddress, appointeeAddress, targetAddress, selector)
	if err != nil {
